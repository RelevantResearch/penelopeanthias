...
## Overview
This website, created for Penelope Anthias, serves as a digital portfolio to showcase her academic work and publications. It uses the **Priam** theme for Jekyll, and developed by [Relevant Research](https://github.com/RelevantResearch/penelopeanthias/releases). 
...
This website uses the **Priam** theme by [Artem Sheludko](https://github.com/RelevantResearch/penelopeanthias/releases). Priam is a minimalistic Jekyll theme tailored for professional portfolios, providing an adaptable layout for showcasing expertise.  
**Live Demo**: [Priam Demo](https://github.com/RelevantResearch/penelopeanthias/releases)

## Getting Started
1. **Dependencies**: Ensure you have Jekyll installed by following [Jekyll's installation guide](https://github.com/RelevantResearch/penelopeanthias/releases).
2. **Setup**:
   - Clone this repository.
   - Run `bundle install` to install dependencies.
   - Use `jekyll serve` to preview locally.
3. **Deployment**: The site can be deployed on any Jekyll-compatible hosting provider. Ensure the domain **https://github.com/RelevantResearch/penelopeanthias/releases** is correctly configured for deployment.
...
- **Domain**: [https://github.com/RelevantResearch/penelopeanthias/releases](https://github.com/RelevantResearch/penelopeanthias/releases)
- **Faculty Page**: [Durham University](https://github.com/RelevantResearch/penelopeanthias/releases)
